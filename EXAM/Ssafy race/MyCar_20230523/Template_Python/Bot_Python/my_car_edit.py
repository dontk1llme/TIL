...
class DrivingClient(DrivingController):
    ...
    def control_driving(self, car_controls, sensing_info):
        ...
        reg_angle = sensing_info.track_forward_angles[angle_num]

        set_steering = (reg_angle - sensing_info.moving_angle) / (180 - sensing_info.speed)
